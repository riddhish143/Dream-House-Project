...
INSERT INTO staff (Staff_number, Full_name, Sex, DOB, Staff_position, Staff_salary, Staff_hired_date, Staff_bonus_pay, Staff_supervisor_name, Branch_number)
VALUES ('S010', 'Catherine Patil', 'Male', '1999-04-17', 'Assistant', 400000, '2016-11-01', 60000, 'Jane Doe', 'B005');
...
Select * from staff where staff_supervisor_name = "John Smith" and Branch_number = "B001";
...
-- Select P.* from Staff s , Properties P where p.Staff_number = s.Staff_number and s.Branch_number = 'B003';
...
WHERE l.Property_number IS NOT NULL;
...
WHERE Powner.Powner_type = 'Private' AND Properties.Property_type = 'House'
